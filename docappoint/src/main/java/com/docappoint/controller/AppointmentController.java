...
public class AppointmentController {
    ...
    public ResponseEntity<Appointment> book(
        ...
        return ResponseEntity.ok(
                appointmentService.bookAppointment(currentUser, request)
        );
    }
    ...
    public ResponseEntity<Appointment> complete(
        ...
        return ResponseEntity.ok(
                appointmentService.completeAppointment(currentUser, appointmentId)
        );
    }
    ...
    public ResponseEntity<Appointment> cancel(
        ...
        return ResponseEntity.ok(
                appointmentService.cancelAppointment(currentUser, appointmentId)
        );
    }
}